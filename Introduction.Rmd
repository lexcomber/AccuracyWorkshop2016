...
A zip file containing the data used in this practical can be downloaded from Lex Comber's GitHub site [https://github.com/lexcomber/AccuracyWorkshop2016/blob/master/GW_Accuracy_Data.zip](https://github.com/lexcomber/AccuracyWorkshop2016/blob/master/GW_Accuracy_Data.zip). You could save this to your working directory and the load it directly. You can also check your current directory using the `getwd()` function. 

Then the packages can be called and the data can be loaded into R. 

You will need to load the data.  This can be done in the following two ways: 
...
This shows that the are a number of continuous and categorical variables. The first three columns of data indicate the ID (`PointID`) and the easting and northing of the data point.
